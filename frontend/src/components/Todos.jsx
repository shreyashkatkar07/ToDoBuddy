...
export const Todos = React.memo(({ todos, fetchTodos, titleRef, descRef }) => {
  ...
  const handleOverflow = useCallback((todo, todoDescRef) => {
    ...
    <div>
      ...
      {expandedTodo && (
        <div className="fixed inset-0 z-50 flex justify-center items-center bg-gray-900 bg-opacity-75">
          <div className="bg-violet-700 hover:bg-violet-900 px-4 py-2 rounded-lg shadow-lg max-w-sm sm:max-w-xl w-full text-white">
            <h2
              className={`text-xl font-semibold ${
